...
$status=1;
$id=intval($_GET['cid']);
$query=mysqli_query($con,"update tblPatient set PostTitle='$posttitle',PostDetails='$postdetails' where id='$id'");
if($query)
{
$msg="Post updated ";
}
...
<?php
$id=intval($_GET['cid']);
$query=mysqli_query($con,"select * from tblPatient where id='$id' ");
