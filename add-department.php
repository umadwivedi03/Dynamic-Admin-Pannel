...
$query=mysqli_query($con,"insert into tbldepartment(PostTitle,PostDetails,Is_Active) values('$posttitle','$postdetails','$status')");
if($query)
{
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Add Our Department</h4>
