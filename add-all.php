...
$status=1;
$query=mysqli_query($con,"insert into tblallabout(PostTitle,Url,PostDetails,PostUrl,Is_Active,PostImage) values('$posttitle','$Urll','$postdetails','$url','$status','$imgnewfile')");
if($query)
{
