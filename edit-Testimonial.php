...
$status=1;
$id=intval($_GET['cid']);
$query=mysqli_query($con,"update Testimonial set PostTitle='$posttitle',CategoryId='$catid',PostDetails='$postdetails' where id='$id'");
if($query)
{
$msg="Post updated ";
}
...
<input type="text"  class="form-control" id="posttitle" value="<?php echo htmlentities($row['CategoryId']);?>" name="category" required>
</div>
