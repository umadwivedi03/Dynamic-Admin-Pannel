...
<?php
$query=mysqli_query($con,"select tblposts.id as postid,tblposts.Specification as Specification,tblposts.PostTitle as title,tblcategory.CategoryName as category,tblsubcategory.Subcategory as subcategory from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join tblsubcategory on tblsubcategory.SubCategoryId=tblposts.SubCategoryId where tblposts.Is_Active=1 ");
...
<td><b><?php echo htmlentities($row['Specification']);?></b></td>
