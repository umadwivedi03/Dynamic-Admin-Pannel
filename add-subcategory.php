...
$status=1;
$query=mysqli_query($con,"insert into tblsubcategory(Specification,CategoryId,Subcategory,SubCatDescription,Is_Active) values('$Specification','$categoryid','$subcatname','$subcatdescription','$status')");
if($query)
{
